...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'boxes.data';
      var REMOTE_PACKAGE_BASE = 'boxes.data';
  ...
  Module['FS_createPath']('/', 'resources', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_boxes.data');

      };
      Module['addRunDependency']('datafile_boxes.data');
   ...
   loadPackage({"files": [{"filename": "/resources/leverage", "start": 0, "end": 257, "audio": 0}, {"filename": "/resources/tangle", "start": 257, "end": 704, "audio": 0}, {"filename": "/resources/crowded", "start": 704, "end": 1093, "audio": 0}, {"filename": "/resources/8x8x8", "start": 1093, "end": 1333, "audio": 0}, {"filename": "/resources/detour2", "start": 1333, "end": 1929, "audio": 0}, {"filename": "/resources/cramped", "start": 1929, "end": 2061, "audio": 0}, {"filename": "/resources/larger", "start": 2061, "end": 2227, "audio": 0}, {"filename": "/resources/persistence", "start": 2227, "end": 2381, "audio": 0}, {"filename": "/resources/result", "start": 2381, "end": 2531, "audio": 0}, {"filename": "/resources/pinwheel", "start": 2531, "end": 3776, "audio": 0}, {"filename": "/resources/unexpected", "start": 3776, "end": 3924, "audio": 0}, {"filename": "/resources/precedence", "start": 3924, "end": 4113, "audio": 0}, {"filename": "/resources/white", "start": 4113, "end": 4250, "audio": 0}, {"filename": "/resources/start", "start": 4250, "end": 4372, "audio": 0}, {"filename": "/resources/gridlock", "start": 4372, "end": 4618, "audio": 0}, {"filename": "/resources/color", "start": 4618, "end": 4618, "audio": 0}, {"filename": "/resources/link", "start": 4618, "end": 4731, "audio": 0}, {"filename": "/resources/levelnames", "start": 4731, "end": 4785, "audio": 0}, {"filename": "/resources/detour3", "start": 4785, "end": 6039, "audio": 0}, {"filename": "/resources/unnamed", "start": 6039, "end": 6340, "audio": 0}, {"filename": "/resources/precedence2", "start": 6340, "end": 6477, "audio": 0}, {"filename": "/resources/link3", "start": 6477, "end": 6598, "audio": 0}, {"filename": "/resources/break", "start": 6598, "end": 6833, "audio": 0}, {"filename": "/resources/levels", "start": 6833, "end": 7097, "audio": 0}, {"filename": "/resources/black", "start": 7097, "end": 7219, "audio": 0}, {"filename": "/resources/border", "start": 7219, "end": 7791, "audio": 0}, {"filename": "/resources/detour", "start": 7791, "end": 8233, "audio": 0}, {"filename": "/resources/7x7x6", "start": 8233, "end": 8410, "audio": 0}, {"filename": "/resources/link4", "start": 8410, "end": 8502, "audio": 0}, {"filename": "/resources/flanking", "start": 8502, "end": 9126, "audio": 0}, {"filename": "/resources/finale", "start": 9126, "end": 10449, "audio": 0}, {"filename": "/resources/holes", "start": 10449, "end": 10889, "audio": 0}, {"filename": "/resources/soclose", "start": 10889, "end": 11118, "audio": 0}, {"filename": "/resources/link2", "start": 11118, "end": 11242, "audio": 0}], "remote_package_size": 11242, "package_uuid": "d654ef61-1fc7-4bcb-87a1-2cd700441b5a"});
...
// {{PRE_LIBRARY}}
  ...
  var GLFW={WindowFromId:function(id) {
        ...
        getDynCaller("vii", GLFW.active.charFunc)(GLFW.active.id, charCode);
        ...
        getDynCaller("viiiii", GLFW.active.keyFunc)(GLFW.active.id, key, keyCode, status, GLFW.getModBits(GLFW.active));
        ...
        getDynCaller("vidd", GLFW.active.cursorPosFunc)(GLFW.active.id, Browser.mouseX, Browser.mouseY);
        ...
        getDynCaller("vii", GLFW.active.cursorEnterFunc)(GLFW.active.id, 1);
      },onMouseleave:function(event) {
        if (!GLFW.active) return;
  
        if (event.target != Module["canvas"] || !GLFW.active.cursorEnterFunc) return;
  
        getDynCaller("vii", GLFW.active.cursorEnterFunc)(GLFW.active.id, 0);
        ...
        getDynCaller("viiii", GLFW.active.mouseButtonFunc)(GLFW.active.id, eventButton, status, GLFW.getModBits(GLFW.active));
        ...
        getDynCaller("vidd", GLFW.active.scrollFunc)(GLFW.active.id, sx, sy);
        ...
        getDynCaller("viii", GLFW.active.windowSizeFunc)(GLFW.active.id, GLFW.active.width, GLFW.active.height);
      },onFramebufferSizeChanged:function() {
        if (!GLFW.active) return;
  
        if (!GLFW.active.framebufferSizeFunc) return;
  
        getDynCaller("viii", GLFW.active.framebufferSizeFunc)(GLFW.active.id, GLFW.active.width, GLFW.active.height);
      },getTime:function() {
            ...
            if (gamepad) {
              if (!GLFW.joys[joy]) {
                ...
                if (GLFW.joystickFunc) {
                  getDynCaller("vii", GLFW.joystickFunc)(joy, 0x00040001); // GLFW_CONNECTED
                }
              }
              ...
              if (GLFW.joys[joy]) {
                ...
                if (GLFW.joystickFunc) {
                  getDynCaller("vii", GLFW.joystickFunc)(joy, 0x00040002); // GLFW_DISCONNECTED
                }
        ...
        function save(file) {
          ...
          reader.onloadend = function(e) {
            ...
            if (++written === count) {
              getDynCaller("viii", GLFW.active.dropFunc)(GLFW.active.id, count, filenames);
        ...
        getDynCaller("viii", win.windowSizeFunc)(win.id, width, height);
        ...
        if (win.windowCloseFunc)
          getDynCaller("vi", win.windowCloseFunc)(win.id);
